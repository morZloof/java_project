...
public class PortfolioManager implements PortfolioManagerInterface {
	...
	public void sellStock(String symbol, int quantity)
			throws PortfolioException, SellingOverQuantityException, StockNotExists {
		Portfolio portfolio = (Portfolio) getPortfolio();
		try {
	 ...
	 * Remove stock
	 * @throws StockNotExists 
	 * @throws SellingOverQuantityException 
	 */
	@Override
	public void removeStock(String symbol) throws StockNotExists, SellingOverQuantityException, BalanceException {
		Portfolio portfolio = (Portfolio) getPortfolio();
		try {
